...
* [Spring Boot Maven Plugin Reference Guide](https://docs.spring.io/spring-boot/3.4.5/maven-pluginInterface)
* [Create an OCI image](https://docs.spring.io/spring-boot/3.4.5/maven-pluginInterface/build-image.html)
