...
CREATE TABLE IF NOT EXISTS `sys_plugin_info` (
    ...
    author                  varchar(100)                          null comment '插件作者',
    main_class              varchar(255)                          not null comment '插件主类全限定名',
    type                    varchar(20) default 'normal'          null comment '插件类型：normal-普通插件，system-系统插件',
    trust                   varchar(20) default 'trusted'         null comment '信任级别：trusted-受信任的，official-官方的',
    required_system_version varchar(20)                           null comment '所需最低系统版本',
    priority                int         default 10                null comment '插件优先级，数值越小优先级越高',
    license                 varchar(50)                           null comment '插件许可证类型',
    category                varchar(50)                           null comment '插件分类',
    jar_file                varchar(255)                          null comment 'jar包路径',
    have_dependency         int         default 0                 not null comment '是否有依赖默认0没有',
    website                 varchar(255)                          null comment '插件官网或文档地址',
    create_time             datetime    default CURRENT_TIMESTAMP not null comment '创建时间',
    update_time             datetime    default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
    create_by               varchar(64)                           null comment '创建者',
    update_by               varchar(64)                           null comment '更新者',
    deleted                 tinyint(1)  default 0                 not null comment '是否删除',
    version_num             int         default 0                 null comment '乐观锁版本号',
  PRIMARY KEY (`id`),
